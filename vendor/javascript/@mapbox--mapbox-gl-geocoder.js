...
/**
     ...
     */
getSelectedIndex:function(t,e){if(e._typeahead){var i=e._typeahead.data;var o=t.id;var n=i.map((function(t){return t.id}));var s=n.indexOf(o);return s}},shouldEnableLogging:function(t){return false!==t.enableEventLogging&&((!t.origin||-1!=t.origin.indexOf("api.mapbox.com"))&&(!t.localGeocoder&&!t.filter))},flush:function(){if(this.eventQueue.length>0){this.send(this.eventQueue);this.eventQueue=new Array}this.timer&&clearTimeout(this.timer);this.flushInterval&&(this.timer=setTimeout(this.flush.bind(this),this.flushInterval))},
/**
...
/**
   ...
   * @private
   */
_getPlaceholderText:function(){if(this.options.placeholder)return this.options.placeholder;if(this.options.language){var t=this.options.language.split(",")[0];var e=q.language(t);var i=z.placeholder[e];if(i)return i}return"Search"},
/**
   * Set input
   * @param {string} searchInput location name or other search input
   * @returns {MapboxGeocoder} this
...
/**
   ...
   * @returns {MapboxGeocoder} this
   */
setOrigin:function(t){this.options.origin=t;this.geocoderService=R(P({accessToken:this.options.accessToken,origin:this.options.origin}));return this},
/**
...
/**
   ...
   * @returns {MapboxGeocoder} this
   */
setAccessToken:function(t){this.options.accessToken=t;this.geocoderService=R(P({accessToken:this.options.accessToken,origin:this.options.origin}));return this},
/**
